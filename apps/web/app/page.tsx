...
export default function Dashboard() {
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      <div className="w-[95%] p-2 border border-sky-950 bg-cyan-950 text-white m-auto my-3 rounded-sm flex-shrink-0">
        <h2 className="text-xl font-semibold">
          Recent Announcements From Your Courses
        </h2>
        <p className="text-sm my-3 text-sky-300">
          There are currently no recent announcements from any of your courses.
        </p>
      </div>
      <div className="m-3 p-2 border border-sky-950 bg-blue-950 text-white my-3 rounded-sm flex-shrink-0">
        ...
        <p className="text-sm my-3 text-sky-300">
          There are currently no upcoming assignment deadlines from any of your
          courses.
        </p>
      </div>
      <div className="w-full border-2 border-slate-500 rounded-tr-md rounded-tl-md bg-slate-800 p-3 flex-1 overflow-y-auto">
        <h3 className="font-semibold text-2xl text-white mb-5">My Courses</h3>
